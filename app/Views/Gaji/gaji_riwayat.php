...
<div class="container-fluid">
    ...
    <div class="card card-primary">
        <div class="card-header py-3">
            <h6 class="font-weight-bold text-primary">Riwayat Gaji</h6>
        </div>
        <div class="card-body">
                        ...
                        <?php foreach ($model['data'] as $row) : ?>
                            <tr>
                                ...
                                <td width="100%">
                                    ...
                                    <button class="btn btn-warning btn-circle btn-edit" data-gaji-id="<?= $row['history_id']; ?>" data-nama="<?= $row['nama']; ?>" data-bulan="<?= $row['bulan']; ?>" data-tahun="<?= $row['tahun']; ?>" data-gaji-pokok="<?= $row['gaji_pokok']; ?>" data-tunjangan="<?= $row['tunjangan']; ?>" data-pemotongan="<?= $row['pemotongan']; ?>" data-status-pembayaran="<?= $row['status_pembayaran']; ?>" data-total="<?= $row['gaji_total']; ?>" data-toggle="modal" data-target="#editGajiModal">
        ...
        <form class="user" method="post" action="edit_gaji">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editGajiModalLabel">Ubah Riwayat Gaji</h5>
