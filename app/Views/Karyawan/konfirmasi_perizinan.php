...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Konfirmasi Perizinan</li>
        </ol>
    </div>
    ...
    <div class="card card-primary">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Konfirmasi Perizinan</h6>
        </div>
        <div class="card-body">
                    ...
                    <tbody>
                        <?php foreach ($model['data'] as $row) : ?>
                            <tr>
                                ...
                                <td width="15%">
                                    <a href="setuju_perizinan?perizinan_id=<?= $row['perizinan_id']; ?>" class="btn btn-success btn-circle">
                                    ...
                                    <a href="hapus_perizinan?perizinan_id=<?= $row['perizinan_id']; ?>" class="btn btn-danger btn-circle">
...
<div class="modal fade" id="editPerizinanModal" tabindex="-1" aria-labelledby="editPerizinanModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <form class="user" method="post" action="edit_perizinan" enctype="multipart/form-data">
